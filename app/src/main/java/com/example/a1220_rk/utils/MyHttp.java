...
public class MyHttp {
    //获取网络请求
    public static String getHttpCon(Context context,String mPath,String mRam){
        String messages = "";

            //String mPath="http://www.xieast.com/api/news/news.php?page="+page+"&pageSize="+pageSize+"";
            try {
